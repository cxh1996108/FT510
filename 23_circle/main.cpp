...
//You might notice a LOT of code duplication with repsect to the
//previous problem:  we will see later how we could avoid the
//duplication.
...
//this duplication of code is not good, but you all have not learned
//how we could avoid it cleanly.
...
//line points just past any whitespace after the "m" that designates
//the command
//first parse an int (circle num) and two doubles (dx, dy) then move
...
//line points just past any whitespace after the "i" that designates
//the command
